...
public class ItemDAO {
    ...
    // 建立範例資料
    public void sample() {
        Item item = new Item(0, new Date().getTime(), color.RED, "關於Android Tutorial的事情.", "Hello content", "","", 0, 0, 0);
        Item item2 = new Item(0, new Date().getTime(), color.BLUE, "Sample Data", "", "","", 25.04719, 121.516981, 0);
        Item item3 = new Item(0, new Date().getTime(), color.GREEN, "一首非常好聽的音樂！", "Hello content", "","", 0, 0, 0);
        Item item4 = new Item(0, new Date().getTime(), color.ORANGE, "儲存在資料庫的資料", "Hello content", "","", 0, 0, 0);
